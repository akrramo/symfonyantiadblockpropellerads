...
class AntiAdblockExtension extends \Twig_Extension
{
    /** @var string */
    private $token = 'YOUR_TOKEN';

    /** @var int */
    private $zoneId = 'YOUR_ID';
    ...
    {
        return array(
            new \Twig_SimpleFilter('showAds', array($this, 'showAdsFilter')),
        );
    }
